...
class pick_dual_bottles_reserved(Base_Task):
    ...
    def play_once(self):
        ...
        bottle1_arm_tag = ArmTag("right")
        bottle2_arm_tag = ArmTag("left")
    ...
    def check_success(self):
        bottle1_target = self.right_target_pose[:2]
        bottle2_target = self.left_target_pose[:2]
        eps = 0.1
